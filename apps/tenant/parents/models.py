...
class ParentProfile(models.Model):
    ...
    def sync_user_identity(self):
        """Keep the parent portal account aligned with the official guardian record.

        ParentProfile is the authoritative school record. Email is synchronized only
        when the address is not already assigned to another login account so an edit
        can never steal another user's identity.
        """
