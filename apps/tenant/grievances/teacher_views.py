...
def grievance_list(request):
    ...
    return render(
        request,
        "portals/teacher/grievances/list.html",
        {"page_obj": page_obj},
    )
...
def grievance_detail(request, pk: int):
    ...
    return render(
        request,
        "portals/teacher/grievances/detail.html",
        {"grievance": grievance},
    )
...
def grievance_submit(request):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            return redirect("teacher_grievances_detail", pk=g.pk)
    else:
    ...
    return render(
        request,
        "portals/teacher/grievances/submit.html",
