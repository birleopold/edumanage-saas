...
class ExamPaperAdmin(admin.ModelAdmin):
    list_display = ('exam', 'offering', 'max_score', 'passing_score', 'date', 'is_published')
    list_filter = ('is_published', 'exam__exam_mode', 'randomize_questions')
...
class OnlineExamAttemptAdmin(admin.ModelAdmin):
    list_display = ('student', 'paper', 'status', 'started_at', 'submitted_at', 'score')
...
class StudentResponseAdmin(admin.ModelAdmin):
    list_display = ('attempt', 'exam_question', 'is_correct', 'marks_awarded', 'answered_at')
    ...
    raw_id_fields = ('attempt', 'exam_question')
