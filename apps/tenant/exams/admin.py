...
class ExamScoreAdmin(admin.ModelAdmin):
    ...
    inlines = (ExamScorePolicyInline,)


@admin.register(ExamPaperPolicy)
class ExamPaperPolicyAdmin(admin.ModelAdmin):
    list_display = (
        "paper",
        "grading_mode",
        "absence_policy",
    ...
    raw_id_fields = ("paper", "responsible_teacher", "makeup_for")


@admin.register(ExamScorePolicy)
class ExamScorePolicyAdmin(admin.ModelAdmin):
    list_display = (
        "score_record",
        "attendance_status",
        "competency_rating",
    ...
    search_fields = (
        ...
        "score_record__paper__exam__name",
    )
