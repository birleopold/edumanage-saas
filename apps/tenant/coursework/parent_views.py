...
def material_detail(request, student_id: int, pk: int):
    ...
    return render(
        request,
        "portals/parent/coursework/material_detail.html",
        {"parent": parent, "student": student, "material": material},
    )
...
def assignment_detail(request, student_id: int, pk: int):
    ...
    return render(
        ...
        {"parent": parent, "student": student, "assignment": assignment, "submission": submission},
    )
